...
- [CI Workflow Coordination](ci-workflow-coordination.md) — how `job-dotnet_test_coverage` fits into the CI pipeline
- [.NET Scripts for CI Workflows](0.0.4/dotnet-scripts-for-ci.md) — why the threshold check script is written in C#
